    ...
    <div className="p-8">
      ...
      {newKey && (
        <div className="mb-4 p-4 rounded-[10px] flex items-center justify-between"
          ...
          <div>
            ...
            <code className="text-[13px] font-mono" style={{ color: '#e5e3e4' }}>{newKey.key_value}</code>
          </div>
      ...
      <div className="rounded-[12px] overflow-hidden border" style={{ borderColor: '#352f31' }}>
        <table className="w-full text-[13px]">
          ...
          <tbody>
            {loading && (
              <tr><td colSpan={9} className="px-4 py-8 text-center" style={{ color: '#5d585c' }}>Loading…</td></tr>
            )}
            {!loading && keys.length === 0 && (
              <tr><td colSpan={9} className="px-4 py-8 text-center" style={{ color: '#5d585c' }}>No keys found</td></tr>
            )}
            {keys.map((k, i) => (
              <tr key={k.id}
                ...
                <td className="px-4 py-3" style={{ color: '#868283' }}>{fmt(k.expires_at)}</td>
      ...
      {showCreate && (
        <div className="fixed inset-0 flex items-center justify-center z-50"
          ...
          <div className="w-[400px] rounded-[17px] p-8"
