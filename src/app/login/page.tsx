...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center"
      ...
      {/* Card */}
      <div className="w-[358px] rounded-[17px] p-[34px] relative"
           style={{
        ...
        <h1 className="text-center text-[26px] font-bold tracking-tight mb-2"
            style={{ color: '#e5e3e4' }}>Passion</h1>
        <p className="text-center text-[13px] mb-6" style={{ color: '#868283' }}>
          Admin sign in
        </p>

        <form onSubmit={handleSubmit} className="flex flex-col gap-0">
          {/* Username */}
          <label className="text-[13px] font-medium mb-[7px]" style={{ color: '#888485' }}>
            Username
          </label>
          <input
            type="text"
            ...
            required
            className="h-[43px] rounded-[8px] px-[11px] text-[14px] outline-none mb-4 transition-colors"
            style={{
              background: '#2a2024',
          ...
          <input
            ...
            required
            className="h-[43px] rounded-[8px] px-[11px] text-[14px] outline-none mb-5 transition-colors"
            style={{
              background: '#2a2024',
              border: '1px solid #352c2f',
              color: '#c5c0c2',
          ...
          {error && (
            <p className="text-[12px] text-center mb-3" style={{ color: '#dc2625' }}>{error}</p>
          )}
          ...
          <button
            ...
            style={{
              background: '#dc2625',
              boxShadow: '0 0 18px rgba(220,38,37,0.45), 0 0 6px rgba(220,38,37,0.3)',
            }}
